...
~go-guru~ is great for source code analysis. The most common thing I use it for is
~go-guru-referrers~, which finds all references to a particular thing across the workspace.
