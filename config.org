...
(use-package org
  ...
  (org-link-frame-setup
   '((vm . vm-visit-folder-other-frame)
     ...
     (file . find-file) ;; Follow links in the same window
     (wl . wl-other-frame)))
...
;; ")
      ...
      :bind (("C-c n l" . org-roam-buffer-toggle)
             ...
             ("C-c d t" . dmai/org-roam-dailies-goto-today)
             ("s-t" . dmai/org-roam-dailies-goto-today)
             :map org-mode-map
             (("C-c n i" . org-roam-node-insert))
             (("C-c n I" . org-roam-insert-immediate))))
(defun dmai/org-roam-dailies-goto-today ()
  (interactive)
...
(defun dmai/gosimports ()
  (interactive)
  (let ((gofmt-command "gosimports"))
    (gofmt)))
#+END_SRC
